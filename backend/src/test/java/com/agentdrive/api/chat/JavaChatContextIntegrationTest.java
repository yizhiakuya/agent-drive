...
class JavaChatContextIntegrationTest {
    ...
    void loadsPersistentRuntimeAndOwnerScopedConfigOperation() {
        ...
        assertThat(operations.find("GET /api/v1/schedules")).isEmpty();
        assertThat(operations.find("PUT /api/v1/schedules/{name}")).isEmpty();
        assertThat(operations.find("DELETE /api/v1/schedules/{name}")).isEmpty();
        assertThat(operations.find("POST /api/v1/schedules/{name}/run")).isEmpty();
